...
public interface AlquilerRepository extends BaseRepository<Alquiler, Long> {
    ...
    List<Alquiler> findByActivoTrueAndCliente_ActivoTrueAndCliente_Id(Long idCliente);
        ...
        /*@Query("""
        select new reportes.dto.com.projects.mycar.mycar_server.AlquilerReporteDTO(
    ...
    @Query("""
            select new com.projects.mycar.mycar_server.dto.reportes.AlquilerReporteDTO(
    ...
    /*@Query("""
        select new reportes.dto.com.projects.mycar.mycar_server.RecaudacionModeloDTO(
    ...
    @Query("""
            select new com.projects.mycar.mycar_server.dto.reportes.RecaudacionModeloDTO(
                coalesce(cv.modelo, 'Sin modelo'),
                coalesce(cv.marca, 'Sin marca'),
                coalesce(cv.cantidadTotalVehiculo, 0),
                count(distinct a.id),
