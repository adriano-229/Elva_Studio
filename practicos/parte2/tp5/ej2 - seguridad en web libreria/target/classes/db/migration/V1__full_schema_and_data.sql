...
('admin@library.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'ADMIN'),
...
-- Insert Books
INSERT INTO book (title, isbn, total_copies, loaned_copies, image_path) VALUES
('The Great Gatsby', '978-0-7432-7356-5', 5, 2, NULL),
...
INSERT INTO publisher (name, book_id) VALUES
-- The Great Gatsby
('Scribner', 1),
-- To Kill a Mockingbird
('J.B. Lippincott & Co.', 2),
...
-- Insert Loans
INSERT INTO loan (loan_date, return_date, status, book_id, user_id) VALUES
-- Active loans
