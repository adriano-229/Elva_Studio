...
insert into direccion (id, calle, numeracion, barrio, manzana_piso, casa_departamento,
                      referencia, eliminado, localidad_id) values
...
insert into persona (id, nombre, apellido, fecha_nacimiento, tipo_documento,
                    numero_documento, telefono, correo_electronico, eliminado) values
...
insert into socio (persona_id, numero_socio, direccion_id, usuario_id) values
(1,1001,'DIR1','USR1'),
(2,1002,'DIR2','USR2');

-- Seed para valor_cuota
insert into valor_cuota (id, mes, anio, valor_cuota, creado_el) values
...
insert into cuota_mensual (id, mes, anio, estado, fecha_vencimiento, valor_cuota_id, eliminado, socio_id, version) values
