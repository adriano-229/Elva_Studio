...
public class LibroServiceImpl extends BaseServiceImpl<Libro, Long> implements LibroService{
	...
	@Autowired
	private ArchivoPdfServiceImpl archivoService;
	...
	@Override
	@Transactional
	public Libro update(Long id, Libro libroNuevo) throws Exception {
		try {
	...
	@Transactional
	public Libro update(Long id, Libro libroNuevo, MultipartFile archivoPdf) throws Exception {
		try {
			...
			libro.setTitulo(libroNuevo.getTitulo());
	        libro.setGenero(libroNuevo.getGenero());
	        libro.setFecha(libroNuevo.getFecha());
	        libro.setPaginas(libroNuevo.getPaginas());
	        libro.setAutores(libroNuevo.getAutores()); 
