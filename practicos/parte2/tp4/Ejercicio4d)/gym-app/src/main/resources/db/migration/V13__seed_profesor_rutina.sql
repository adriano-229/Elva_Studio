...
merge into persona (id, nombre, apellido, fecha_nacimiento, tipo_documento,
                    numero_documento, telefono, correo_electronico, eliminado, sucursal_id)
key(id) values
(1001, 'Laura', 'Diaz', '1985-03-15', 'DNI', '30999888', '+54 261 4000010', 'laura.diaz@sport.com', false, 'SUC-001');

merge into empleado (persona_id, activo, tipo)
...
merge into rutina (id, fecha_inicia, fecha_finaliza, objetivo, activo, estado_rutina, socio_id, profesor_id)
key(id) values
(100, '2025-01-02', '2025-01-30', 'Plan de fuerza tren inferior', true, 'EN_PROCESO', 1, 1001);

merge into detalle_diario (id, numero_dia, activo, rutina_id)
key(id) values
(1000, 1, true, 100),
(1001, 3, true, 100);

merge into detalle_ejercicio (id, actividad, series, repeticiones, activo, grupo_muscular, detalle_diario_id)
key(id) values
