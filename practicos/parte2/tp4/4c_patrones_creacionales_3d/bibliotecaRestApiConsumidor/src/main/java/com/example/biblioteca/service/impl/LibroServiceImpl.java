...
import com.example.biblioteca.iterator.ColeccionLibros;
import com.example.biblioteca.iterator.LibroIterator;
...
public class LibroServiceImpl extends BaseServiceImpl<LibroDTO, Long> implements LibroService{
	...
	public List<LibroDTO> buscarPorFiltro(TipoBusqueda busqueda, String filtro) throws Exception {
		...
		try {
			return daoLibro.buscarPorFiltro(busqueda, filtro);
