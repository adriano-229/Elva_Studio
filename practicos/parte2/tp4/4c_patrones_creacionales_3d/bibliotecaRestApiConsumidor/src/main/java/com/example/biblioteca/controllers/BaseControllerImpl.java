...
public abstract class BaseControllerImpl<E extends BaseDTO, S extends BaseServiceImpl<E, Long>> implements BaseController<E, Long>{
	...
	public String guardar(@ModelAttribute E entity, Model model) {
	    try {
	    	if (entity instanceof LibroDTO dto) {
	    		System.out.println("ESTOY EN EL CONTROLADOR DEL CONSUMIDOR");
	    		System.out.println("LIBRODTO GETTIPO: " + dto.getTipo());
	    	}
	...
	public String modificar(@PathVariable Long id, Model model) {
	    try {
	        ...
	        if (entity != null) {
	        	...
	        	}else if (entity instanceof LibroDTO libro) {
