...
import com.example.biblioteca.serviceImpl.BaseServiceImpl;
...
public abstract class BaseControllerImpl<E extends Base, S extends BaseServiceImpl<E, Long>> implements BaseController<E, Long>{
	...
	public ResponseEntity<?> save(@RequestBody E entity){
		try {
			...
			System.out.println("ESTOY EN SAVE DEL PRODUCTOR");
	...
	public ResponseEntity<?> update(@PathVariable Long id, @RequestBody E entity){
		try {
			if (entity instanceof Persona person) {
				for (Libro libro: person.getLibros()) {
					System.out.println(libro.getTitulo() + ": " + libro.getId());
				}
