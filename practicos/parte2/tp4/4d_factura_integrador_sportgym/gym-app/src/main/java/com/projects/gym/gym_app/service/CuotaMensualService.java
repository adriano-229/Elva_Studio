...
import com.projects.gym.gym_app.service.ServicioBase;
...
public class CuotaMensualService implements ServicioBase<CuotaMensual, Socio>{
	...
	@Override
	@Transactional
	public CuotaMensual actualizar(CuotaMensual entity, String id) throws Exception {
		try {
	...
	@Override
	@Transactional
	public boolean eliminarPorId(String id) throws Exception {
	...
	@Override
	@Transactional
	public CuotaMensual buscarPorId(String id) throws Exception {
		try {
			Optional<CuotaMensual> opt = this.repository.buscarCuotaMensual(id);
			CuotaMensual cuotaMensual = opt.get();
	...
	@Transactional
	public List<CuotaMensual> listarPorFecha(Socio socio, LocalDate  fechaDesde, LocalDate  fechaHasta) throws Exception{
		try {
	...
	// listarCuotaMensualPorFecha ----------------------
		@Transactional
		public List<CuotaMensual> listarPorFechayEstado(Socio socio, LocalDate  fechaDesde, LocalDate  fechaHasta, EstadoCuota estado) throws Exception{
			try {
		...
		@Transactional
		public List<CuotaMensual> listarPorIds(List<String> idCuotas) throws Exception{
			try {
		...
		/*@Transactional
		public BigDecimal valorCuotaPorSocio(Socio socio) {
