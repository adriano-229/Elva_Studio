...
merge into factura (id, numero_factura, fecha_factura, total_pagado,
                    estado, eliminado, socio_id, forma_pago_id,
                    observacion_pago, observacion_anulacion, version)
key(id) values
...
merge into detalle_factura (id, factura_id, cuota_mensual_id, importe, eliminado)
key(id) values
